...
public class AdminGUI {
    ...
    public static void main(String[] args) {
        ...
        addBtn.addActionListener(e -> Admin.addEmployee());
        updateBtn.addActionListener(e -> Admin.updateEmployee());
        removeBtn.addActionListener(e -> Admin.deleteEmployee());
        orderBtn.addActionListener(e -> Admin.changeOrder());
        deleteCustomerBtn.addActionListener(e -> Admin.deleteCustomer());
